...
Route::get('/admin/room-type/update/{id}', function ($id) { return view('admin.room-type-update', ['id' => $id]); })->name('admin.room-type.update');
Route::get('/admin/room-type/detail/{id}', function ($id) { return view('admin.room-type-detail', ['id' => $id]); })->name('admin.room-type.detail');
