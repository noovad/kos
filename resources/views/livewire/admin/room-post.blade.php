<div>
    ...
    <dialog wire:ignore.self id="modalCreate" class="modal">
        <div class="modal-box">
            ...
            <input wire:model='form.name' type="text" id="name" placeholder="Type here"
                class="input input-sm input-bordered w-full text-xs mt-1" />

            <label for="room_type" class="block mt-4 text-xs text-gray-700">Room Type:</label>
            <select wire:model="form.room_type_id" id="room_type"
