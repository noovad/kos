<div>
    ...
    <div class="mx-auto text-center">
        <div x-data="{ selected: 'tipe kamar' }" class="w-full my-4">
            ...
            <div class="grid grid-cols-11 gap-2 p-2">
                ...
                <div class="expand-button col-span-2 flex flex-col justify-center">
                    <a class="btn btn-xs bg-blue text-white border-none"
                        href="{{ route('admin.room-type-update', ['id' => $item->id]) }}"> <svg
                ...
                <div class="expand-button col-span-2 flex flex-col justify-center">
                    <button class="btn btn-xs bg-red-600 text-white border-none"
                        onclick="document.getElementById('deleteModal{{ $item->id }}').showModal()"> <svg
                ...
                <div class="expand-button col-span-2 flex flex-col justify-center">
                    <a class="btn btn-xs bg-blue text-white border-none"
                        href="{{ route('user.room-detail', str_replace(' ', '_', $item->name)) }}"> <svg
                            xmlns="http://www.w3.org/2000/svg" color="white" width="16" height="16"
