<div>
    @section('title', $title ?? '')
    <div class="mt-4 mb-4">
        <a class="btn btn-xs bg-blue text-white border-none" href="{{ route('admin.room-type-posts') }}">+Tambah Tipe
            Kamar</a>
    </div>
    <hr>
    ...
    <div class="card border border-grey text-black mt-4 mb-4">
        <div class="grid grid-cols-11 gap-2 p-2">
            ...
            <div class="expand-button col-span-2 flex flex-col justify-center">
                <button class="btn btn-xs bg-red-600 text-white border-none" onclick="document.getElementById('deleteModal{{ $item->id }}').showModal()"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" color="white" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
