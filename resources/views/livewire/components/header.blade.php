        ...
        <div class="navbar-end">
            <div>
                @if (auth()->check() && auth()->user()->role == 'admin')
                    ...
                    <!-- Indikator Chat untuk Admin -->
                    <div class="indicator">
                        @if ($indicator)
                            <span class="indicator-item badge badge-xs bg-white border-white"></span>
                        @endif
                        <a href="{{ route('admin.chat-menu') }}" class="mx-2 font-semibold">
                            <small>Chat</small>
                        </a>
                    </div>
                ...
                @elseif (auth()->check() && auth()->user()->role == 'user')
                    ...
                    <!-- Indikator Chat untuk User -->
                    <div class="indicator">
                        @if ($indicator)
                            <span class="indicator-item badge badge-xs bg-white border-white"></span>
                        @endif
                        <a href="{{ route('user.chat') }}" class="mx-2 font-semibold">
                            <small>Chat</small>
                        </a>
                    </div>
