...
<div class="mx-auto text-center lg:bg-white lg:drop-shadow-up bg-base fixed bottom-16 left-0 right-0 max-full py-4 px-4 z-50 lg:bottom-0 lg:bottom">
    <div class="flex justify-between max-w-2xl mx-auto lg:px-20">
        <input wire:model='message' id="myInput" placeholder="Masukan Pesan" type="text" class="input input-bordered border-blue w-full" />
