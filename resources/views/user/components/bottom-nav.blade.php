<div class="btm-nav mx-auto max-w-lg bg-white drop-shadow-up text-black">
    ...
    <a href="{{ route('user.bill') }}">
        <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="currentColor" class="bi bi-coin" viewBox="0 0 16 16">
            <path
